...
def cancel_faturamento_pos():
    ...
    try:
        ...
        db = SessionLocal()
        target_pos = ['213827', '213842', '213866', '213796', '213923']
        ...
        details_text = "Cancelamento solicitado via e-mail pelo Faturamento (Anderson Moreno) em 16/09/2026"
        ...
        db.commit()
        print("SUCCESS: All 5 POs and their items successfully cancelled with audit trail committed!")
