...
def cancel_faturamento_batch_2309():
    ...
    try:
        ...
        target_pos_map = {
            '213350': 'NF CANCELADA',
            '213361': 'ATENDIDO COM NF DE DEVOLUCAO',
            '213621': 'ATENDIDO COM NF DE DEVOLUCAO',
            '213739': 'NF CANCELADA',
            '214170': 'NF CANCELADA',
            '214313': 'NF CANCELADA',
            '214338': 'NF CANCELADA'
        ...
        for po in pos:
            ...
            details_text = f"Cancelamento solicitado via e-mail pelo Faturamento em 23/09/2026. Motivo: {reason}"
                ...
                for item in po.items:
                    ...
                    audit_entry = AuditLog(
                        ...
                        extra_data={
                            ...
                            "requested_by": "Faturamento",
                            "reason": reason,
                            "requested_at": "23/09/2026",
            ...
            print(f"  - PO #{po.po_number} ({client_name[:35]}): {old_status} -> CANCELLED [{reason}]")
